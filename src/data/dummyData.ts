...
export const agents: Agent[] = [
  { id: 'ag-gen-beats', name: 'Génération Beats', category: 'génération', objective: 'Générer les beats d\'une scène — macro ou micro — depuis le contexte Portes', simulatedCost: '$0.12', criticality: 'moyenne', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['arc_index', 'character_index'], lastRun: '2026-05-07' },
  { id: 'ag-gen-chapter', name: 'Génération Chapitre', category: 'génération', objective: 'Assembler un chapitre Tome I — respect alternance macro/micro', simulatedCost: '$0.85', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['world_index', 'character_index', 'arc_index', 'style_index'] },
  { id: 'ag-audit-canon', name: 'Audit Canon', category: 'audit', objective: 'Vérifier conformité aux lois Couplage / Seuil / Friction / Latence', simulatedCost: '$0.08', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'read-only', futureIndexes: ['world_index'], lastRun: '2026-05-08' },
  { id: 'ag-audit-timeline', name: 'Audit Timeline', category: 'audit', objective: 'Hiérarchie Lagrange-4 → Walvis Bay → Anvers et chronologie', simulatedCost: '$0.06', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'read-only', futureIndexes: ['arc_index'], lastRun: '2026-05-07' },
  { id: 'ag-audit-chars', name: 'Audit Personnages', category: 'audit', objective: 'Cohérence Brice / Sabrina / Amina / Karim / Mila / Jonas / SAS', simulatedCost: '$0.10', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'read-only', futureIndexes: ['character_index'], lastRun: '2026-05-06' },
  { id: 'ag-audit-respiration', name: 'Audit Rythme & Respiration', category: 'audit', objective: 'Alternance macro/micro et respirations entre chapitres', simulatedCost: '$0.06', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'read-only', futureIndexes: ['arc_index', 'style_index'] },
  { id: 'ag-audit-cognitive', name: 'Audit Charge Cognitive', category: 'diagnostic', objective: 'Charge cognitive par scène — un détail technique par scène', simulatedCost: '$0.05', criticality: 'moyenne', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['draft_index'] },
  { id: 'ag-audit-balance', name: 'Audit Équilibrage Intrigue', category: 'audit', objective: 'Équilibre des 6 arcs — A, B, C, D, E, F', simulatedCost: '$0.09', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['arc_index'] },
  { id: 'ag-audit-coherence', name: 'Audit Cohérence Tome', category: 'audit', objective: 'Cohérence cross-chapitres et hiérarchie Lagrange-4 / Walvis Bay', simulatedCost: '$0.15', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['world_index', 'character_index', 'arc_index'] },
  { id: 'ag-audit-escalade', name: 'Audit Escalade', category: 'audit', objective: 'Progression de tension chapitre par chapitre', simulatedCost: '$0.06', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['arc_index'] },
  { id: 'ag-audit-revelations', name: 'Audit Révélations', category: 'audit', objective: 'Distribution B+ et payoffs — doctrine silencieuse', simulatedCost: '$0.07', criticality: 'moyenne', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['arc_index'] },
  { id: 'ag-audit-repetitions', name: 'Audit Répétitions Structurelles', category: 'audit', objective: 'Détection des motifs et phrases-couteaux répétés', simulatedCost: '$0.05', criticality: 'moyenne', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['draft_index', 'style_index'], lastRun: '2026-05-08' },
  { id: 'ag-audit-scidensity', name: 'Audit Densité Scientifique', category: 'audit', objective: 'Vérifier « un détail technique par scène »', simulatedCost: '$0.04', criticality: 'moyenne', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['science_index'] },
  { id: 'ag-audio-check', name: 'Vérification Notes Audio', category: 'audit', objective: 'Contrôler la prise en compte des notes audio dans la version courante', simulatedCost: '$0.08', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['audio_memory_index', 'draft_index'] },
  // Agents spécifiques projet — Tome I
  { id: 'ag-hierarchie-l4-walvis', name: 'audit_hierarchie_lagrange_walvis', category: 'audit', objective: 'Vérifier la hiérarchie narrative Lagrange-4 (antériorité) > Walvis Bay (acte public)', simulatedCost: '$0.07', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['arc_index', 'world_index'] },
  { id: 'ag-trace-non-humanisee', name: 'audit_trace_non_humanisee', category: 'audit', objective: 'Vérifier la règle absolue CAN-010 — la Trace B+ n\'est jamais un personnage', simulatedCost: '$0.05', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'read-only', futureIndexes: ['style_index', 'world_index'] },
  { id: 'ag-cout-par-activation', name: 'audit_cout_par_activation', category: 'audit', objective: 'Matérialiser un coût (cognitif, humain, financier, biologique, politique) par activation d\'Arche', simulatedCost: '$0.06', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['arc_index', 'science_index'] },
  { id: 'ag-phrase-couteau', name: 'audit_phrase_couteau', category: 'audit', objective: 'Vérifier la présence et la qualité de la phrase-couteau de fin de chapitre', simulatedCost: '$0.04', criticality: 'moyenne', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['style_index', 'draft_index'] },
  { id: 'ag-log-canon-systemique', name: 'audit_log_canon_systemique', category: 'audit', objective: 'Vérifier la cohérence du journal systémique : Arches actives, ΔS, R, incidents bio, niveau de régulation, dépendance sociale D', simulatedCost: '$0.09', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'read-only', futureIndexes: ['world_index', 'science_index'] },
  { id: 'ag-prise-en-compte-notes-audio', name: 'audit_prise_en_compte_notes_audio', category: 'audit', objective: 'Vérifier que chaque note audio non rejetée a bien été intégrée dans la version courante', simulatedCost: '$0.05', criticality: 'haute', status: 'simulated', rewriteRights: false, permissionLevel: 'recommendation', futureIndexes: ['audio_memory_index', 'draft_index'] },
  // Réécriture / style / export
  { id: 'ag-rewrite-targeted', name: 'Réécriture Ciblée', category: 'réécriture', objective: 'Réécrire des passages ciblés — beats, fins de chapitre', simulatedCost: '$0.20', criticality: 'haute', status: 'simulated', rewriteRights: true, permissionLevel: 'targeted-rewrite-with-validation', futureIndexes: ['draft_index', 'style_index'] },
  { id: 'ag-rewrite-deep', name: 'Réécriture Profonde', category: 'réécriture', objective: 'Restructurer un chapitre — approbation auteur requise', simulatedCost: '$0.60', criticality: 'haute', status: 'simulated', rewriteRights: true, permissionLevel: 'deep-rewrite-with-validation', futureIndexes: ['draft_index', 'style_index', 'arc_index'] },
  { id: 'ag-style-follett', name: 'Style Pass — Follett', category: 'style', objective: 'Harmoniser le style — registre Follett, phrase-couteau de fin', simulatedCost: '$0.15', criticality: 'moyenne', status: 'simulated', rewriteRights: true, permissionLevel: 'targeted-rewrite-with-validation', futureIndexes: ['style_index'] },
  { id: 'ag-export-text', name: 'Export Texte', category: 'export', objective: 'Préparer texte / markdown / JSON structuré', simulatedCost: '$0.02', criticality: 'basse', status: 'simulated', rewriteRights: false, permissionLevel: 'read-only', futureIndexes: ['draft_index'] },
];
